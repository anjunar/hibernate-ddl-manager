...
- **Model coverage:** JSON columns, collections inside embeddables, `@CollectionId` bags,
  other CHECK constraints, `ON DELETE` actions. Each new type needs a name in the history's
  JSON format.
