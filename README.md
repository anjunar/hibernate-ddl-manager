...
with the common basic types, `UUID` keys, `@ManyToOne` and `@OneToOne` associations
(foreign keys), unique constraints and indexes can be mapped; enums, `@Lob` and collections
cannot yet.
