...
if ($Version.EndsWith("-SNAPSHOT")) {
    throw "Version $Version is a snapshot. Snapshots go to Central's snapshot repository with 'sbt --server publishSigned' and no bundle upload."
}

if (-not $DeploymentName) {
    $DeploymentName = "com.anjunar.hibernateddl:hibernate-ddl-manager:$Version"
}
